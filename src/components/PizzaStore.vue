        ...
        <div class="container mx-auto px-4">
            <div class="bg-gray-50 px-12 py-16 rounded-lg text-gray-400">
              ...
              Most Loved Items </h3>
                ...
                <div class="-mx-3 flex flex-wrap justify-center mb-12" data-pg-name="PizzaCard - Container">
                    <PizzaCard v-for="(pizza, index) in pizzas" :description="pizza.description" :image="pizza.image" :name="pizza.name" :price="pizza.price"/>
                </div>
                <div>
            ...
            <div class="bioIngredients max-w-screen-lg mx-auto py-12 md:flex">
              ...
              Our hand picked Bio Products </h3>
                    ...
                    <p class="border-b border-solid font-sans leading-tight pb-8 px-8 text-base text-center text-zinc-800">
